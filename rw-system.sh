...
changeKeylayout() {
    ...
    if getprop ro.vendor.build.fingerprint | grep -iq \
        ...
        -e xiaomi/platina -e iaomi/perseus -e xiaomi/ysl -e Redmi/begonia -e xiaomi/nitrogen -e xiaomi/daisy -e xiaomi/sakura \
...
if grep -qF 'PowerVR Rogue GE8100' /vendor/lib/egl/GLESv1_CM_mtk.so ||
    ...
    ) | grep -qiE -e msm8917 -e msm8937 -e msm8940); then
